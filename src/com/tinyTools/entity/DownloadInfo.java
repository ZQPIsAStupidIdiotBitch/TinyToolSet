package com.tinyTools.entity;

import java.io.File;

public class DownloadInfo {
	// 下载文件默认保存路径
	private final static String DEFAULT_FILE_PATH = "D:" + File.separator
			+ "downloadTemp";
	// 默认分块数、线程数
	...
	public DownloadInfo(String url, String fileName, String filePath,
		...
		this.url = url;
		this.fileName = (fileName == null || "".equals(fileName)) ? getFileNameByUrl(url)
				: fileName;
		this.filePath = (filePath == null || "".equals(filePath)) ? DEFAULT_FILE_PATH
				: filePath;
